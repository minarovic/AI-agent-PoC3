...
def demonstrate_direct_prompt_editing():
    ...
    print("📝 Current system prompt (first 100 chars):")
...
Provide strategic market insights and competitive intelligence.""",
    ...
    PromptRegistry.update_prompt(
        "system_prompt", prompt_variations["financial_analyst"]
    )

    # Create new agent with updated prompt
    create_memory_agent()
    print("✅ Agent recreated with financial analyst prompt")

    # Show the change took effect
    new_prompt = PromptRegistry.get_prompt("system_prompt")
    print("📝 Updated prompt (first 100 chars):")
...
def demonstrate_langsmith_integration():
    ...
    print("🔧 Environment setup for LangSmith:")
...
def demonstrate_prompt_editing_workflow():
    ...
    print("🔄 Recommended workflow for prompt optimization:")
...
def main():
    ...
    print("\n🎯 NEXT STEPS:")
    print("1. Set up LangSmith account and API key")
    print("2. Deploy agent to LangGraph Platform")
    print("3. Open LangGraph Studio")
    print("4. Start editing prompts using demonstrated methods")
    print("5. Refer to docs/langgraph_studio_prompt_editing.md for detailed guidance")
