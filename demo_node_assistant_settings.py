...
def main():
    ...
    try:
        ...
        print("✅ Answer: YES - The Memory Agent has node-specific assistant settings configured.")
        ...
        sample_config = {
            "nodes": dict(list(studio_config['nodes'].items())[:2]),  # Show first 2 nodes
            "assistants": dict(list(studio_config['assistants'].items())[:2])  # Show first 2 assistants
        }
