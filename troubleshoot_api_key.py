...
def main():
    ...
    try:
        ...
        print(f"   Preview: {api_key[:15]}...{api_key[-4:] if len(api_key) > 4 else ''}")
        ...
        try:
            ...
            if "401" in error_str or "authentication" in error_str:
                ...
                print("   - Review OpenAI documentation: https://platform.openai.com/docs")
        ...
        if os.path.exists(langgraph_config):
            ...
            if 'env' in config:
                ...
                print("⚠️  No 'env' field in langgraph.json - environment variables may not be loaded")
        else:
