...
from memory_agent.state import State, ensure_serializable, merge_dict_values
...
class TestSerializationFix:
    ...
    def test_ensure_serializable_nested_structure(self):
        ...
        nested_data = {
            ...
            "list_with_map": [{"normal": "dict"}, MockMapComposite({"another": "map"})],
            "tuple_with_map": ("normal_item", MockMapComposite({"tuple_map": "value"})),
        }
    ...
    def test_graph_nodes_return_serializable_data(self):
        ...
        # Create test state
        test_state = State(
            messages=[], current_query="Tell me about MB TOOL supplier risks"
        )
